...
module "vpc" {
  ...
  # Additional Tags to public Subnets 
  public_subnet_tags = {
    Type                             = "Public Subnets"
    "asg.io/role/elb"                = "1"
    "asg.io/cluster/${var.vpc_name}" = "owned"
  }

  # Additional Tags to private Subnets 
  private_subnet_tags = {
    Type                             = "Private Subnets"
    "asg.io/role/internal-elb"       = "1"
    "asg.io/cluster/${var.vpc_name}" = "owned"
  }

  # Additional Tags to database Subnets 
